...
<html>
    ...
    <title>
        rose
          ...
          <meta name="keywords" content=" orange, rose, tulip, white, red">
 ...
 ul { list-style-type: none;margin: 0;padding: 0;overflow: hidden; background-color: #333; }
       ...
       .card button:hover {
        ...
        text-align: center;}
               .header {position:sticky ; top:0; right: 0; }
...
#bask{
     ...
     <!-- Links (sit on top) -->
         <header style="color: white;">
          <h5 class="h5"><a href="main3.php">RETURN TO HOME PAGE</a><br><br><br></h5>
        <nav>
            
     <a href="../html/cart2.php"  id="bask" style="background-attachment: fixed;"> <input  type="image" src="../images/cart5.png" width="40" value="View Cart" align="right" ></a>
...
<td>    <div class="card">
        <img src="../images/s1.jpeg" width="200" height="250" align="center">
        <p> <b>Orange Rose</b> </p>
...
<td>
        <div class="card">
        <img src="../images/s2.jpeg" width="200" height="250" align="center" >
            <p><b> White Rose </b></p>
        <span  class="fa fa-star ratting "></span>
           <span  class="fa fa-star ratting "></span>
           <span  class="fa fa-star ratting "></span>
...
<td>
        <div class="card">
        <img src="../images/s4.jpeg" width="200" height="250" align="center">
        <p><b> Red Rose</b> </p>
        <span  class="fa fa-star ratting "></span>
           <span  class="fa fa-star ratting "></span>
           <span  class="fa fa-star ratting "></span>
...
<td>
        <div class="card">
        <img src="../images/s5.jpeg" width="200" height="250" align="center">
        <p><b> Tulip </b> </p>
        <span  class="fa fa-star ratting "></span>
           <span  class="fa fa-star ratting "></span>
           <span  class="fa fa-star ratting "></span>
...
<td>
        <div class="card">
        <img src="../images/s3.jpeg" width="200" height="250" align="center">
        <p><b> Pink Rose</b> </p>
        <span  class="fa fa-star ratting "></span>
           <span  class="fa fa-star ratting "></span>
           <span  class="fa fa-star ratting "></span>
